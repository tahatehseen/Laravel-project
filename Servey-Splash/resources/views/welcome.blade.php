                                ...
                                <div class="p-2 mt-3">
                                    <form action="{{route('setup')}}">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="number" name="phoneNumber" class="form-control" id="phoneNumber" placeholder="Enter Phone Number" required>
                                        </div>
                                        <div class="mb-2">
                                        ...
                                        <div class="mb-2">
                                            <label class="form-label" for="password-input">Create Password</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" name="password" class="form-control pe-5 password-input" placeholder="Create password" id="password-input" required>
