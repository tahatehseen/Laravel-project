                    ...
                    <div style="display:inherit;">
                        <div class="Polaris-InlineStack" style="--pc-inline-stack-align:center;--pc-inline-stack-block-align:center;--pc-inline-stack-wrap:wrap;--pc-inline-stack-gap-xs:var(--p-space-400);--pc-inline-stack-flex-direction-xs:row">
                            <div style="color:var(--p-color-text-info-on-bg-fill);width:100%;">
                                <h2 style="font-weight: var(--p-font-weight-semibold);" class="Polaris-Text--root Polaris-Text--bodyMd">Add Key:</h2>
                        ...
                        <div class="Polaris-InlineStack" style="--pc-inline-stack-align:center;--pc-inline-stack-block-align:center;--pc-inline-stack-wrap:wrap;--pc-inline-stack-gap-xs:var(--p-space-400);--pc-inline-stack-flex-direction-xs:row">
                            <div class="Polaris-LegacyCard" style="color:var(--p-color-text-info-on-bg-fill);width:100%">
                                <div class="Polaris-LegacyCard__Section" style="padding: var(--p-space-400); display: flex;">
                                    <div class="Polaris-TextField Polaris-Button--pressable" style="width: 50%;">
                                        <input id="connection-key" class="Polaris-TextField__Input" type="text" placeholder="Add Key From the Parent Store">
                                        <div class="Polaris-TextField__Backdrop"></div>
                                    </div>
                                    <div style="display: flex; margin-left: var(--p-space-200);">
                                        <a href="#" style="margin-right: var(--p-space-100);" id="save" class="Polaris-Button Polaris-Button--pressable Polaris-Button--variantSecondary Polaris-Button--sizeMedium Polaris-Button--textAlignCenter">
                                            <img width="17" src="https://img.icons8.com/?size=50&id=18765&format=png" alt="">
                                        </a>
                                        <a href="{{Route('home')}}" style="margin-left: var(--p-space-100);" class="Polaris-Button Polaris-Button--pressable Polaris-Button--variantSecondary Polaris-Button--sizeMedium Polaris-Button--textAlignCenter">
