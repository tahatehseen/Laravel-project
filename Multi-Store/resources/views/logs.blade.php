                                ...
                                <tbody>
                                    <tr class="Polaris-DataTable__TableRow Polaris-DataTable--hoverable">
                                        ...
                                        <td style="text-align: center;" class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric product-name">
                                            ...
                                            <a href="#" id="updateBtn1" class="Polaris-Button Polaris-Button--pressable Polaris-Button--variantSecondary Polaris-Button--sizeSmall Polaris-Button--textAlignCenter Polaris-Button--iconOnly" type="button">
                                    ...
                                    <tr class="Polaris-DataTable__TableRow Polaris-DataTable--hoverable">
                                        ...
                                        <td style="text-align: center;" class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric product-name">
                                            ...
                                            <a href="#" id="updateBtn2" class="Polaris-Button Polaris-Button--pressable Polaris-Button--variantSecondary Polaris-Button--sizeSmall Polaris-Button--textAlignCenter Polaris-Button--iconOnly" type="button">
                                                <span class="Polaris-Icon"><img class="Polaris-Button__Icon" width="15" src="https://img.icons8.com/?size=50&id=49&format=png" alt=""></span>
                                            </a>
                                        </td>
                                    </tr>
