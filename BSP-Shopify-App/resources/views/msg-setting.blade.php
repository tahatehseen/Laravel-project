                ...
                <div style="margin:5px 0; display:inherit; height:auto; width:auto">
                    <div class="Polaris-Card">
                        <div class="Polaris-LegacyCard" style="padding:var(--p-space-600);">
                            ...
                            <form>
                                <!-- form section 1 -->
                                <h3 style="font-weight:600; font-size: medium;">Event Abandoned First Follow Up</h3>
                                <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-400)">
                                    <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                        ...
                                        <div style="margin:var(--p-space-200) 0;">
                                            <label style="padding:4px 0;" id=":R4q6:Label" for=":R4q6:" class="Polaris-Label__Text">
                                                <span class="Polaris-Text--root Polaris-Text--bodyMd">Follow Up Timing:</span>
                                            </label>
                                            <div class="Polaris-Select">
                                                <select id="re-attampt" name="reattampt" class="Polaris-Select__Input" aria-invalid="false">
                                        ...
                                        <div style="margin:var(--p-space-200) 0;">
                                            <label style="padding:4px 0;" id=":R4q6:Label" for=":R4q6:" class="Polaris-Label__Text">
                                                <span class="Polaris-Text--root Polaris-Text--bodyMd">Attached Discount Code:</span>
                                            </label>
                                            <div class="Polaris-Select">
                                                <select id="re-attampt" name="reattampt" class="Polaris-Select__Input" aria-invalid="false">
                                                    <option disabled selected value="1">Attached Discount Code</option>
                                                    <option value="2">NO</option>
                                                    <option value="3">code 1</option>
                                                </select>
                                                <div class="Polaris-Select__Content" aria-hidden="true">
                                                    <span class="Polaris-Select__SelectedOption">Attached Discount Code</span>
                                                    <span class="Polaris-Select__Icon">
                                                        <span class="Polaris-Icon">
                                                            <span class="Polaris-Text--root Polaris-Text--visuallyHidden">
                                                            </span>
                                        ...
                                        <small>* Add Variable in Message: %DISCOUNT_CODE%</small>
                                    </div>
                                </div>
                                <hr>
                                <!-- form section 2 -->
                                <h3 style="font-weight:600; font-size: medium;">Event Abandoned Second Follow Up</h3>
                                <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-400)">
                                    <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                        <!-- status feild -->
                                        <div style="margin:var(--p-space-200) 0;">
