...
<body>
    ...
    <div style="margin:0px 50px; height:auto; padding-bottom: 15px; display: flex; justify-content: center;">
        <div style="width: 85%;">
            <h3 style="font-size: large; margin:var(--p-space-200) 0;">Shopify Events for Customer</h3>
            <div class="Polaris-InlineGrid" style="--pc-inline-grid-grid-template-columns-xs:repeat(2, minmax(0, 1fr));--pc-inline-grid-gap-xs:var(--p-space-400)">
                <div style="margin:5px 0; display:inherit; height:auto; width:auto">
                    <div class="Polaris-LegacyCard" style="padding:var(--p-space-600);">
                        <!-- Form -->
                        <form>
                            <!-- form section 1 -->
                            <h3 style="font-weight:600; font-size: medium;">Event Order Placed</h3>
                                ...
                                <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                    ...
                                    <div style="margin:var(--p-space-200) 0;">
                                        ...
                                        <div class="Polaris-TextField">
                                            <textarea rows="6" cols="10" id=":R4q6:" class="Polaris-TextField__Input" aria-labelledby=":R4q6:Label" aria-invalid="false" value="" placeholder="Type Your Message"></textarea>
                            ...
                            <hr>
                            <!-- form section 2 -->
                            <h3 style="font-weight:600; font-size: medium; margin-top: 10px;">Event Order Fulfilled / Shipped</h3>
                            <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-400)">
                                <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                    <!-- status feild -->
                                    <div style="margin:var(--p-space-200) 0;">
                            ...
                            <hr>
                            <!-- form section 3 -->
                            <h3 style="font-weight:600; font-size: medium; margin-top: 10px;">Event Order Fulfilled / Shipped (without Tracking)</h3>
                            <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-400)">
                                <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                    <!-- status feild -->
                                    <div style="margin:var(--p-space-200) 0;">
                            ...
                            <hr>
                            <!-- form section 4 -->
                            <h3 style="font-weight:600; font-size: medium; margin-top: 10px;">Event Order Cancelled</h3>
                            <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-400)">
                                <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                    <!-- status feild -->
                                    <div style="margin:var(--p-space-200) 0;">
                            ...
                            <hr>
                            <!-- form section 5 -->
                            <h3 style="font-weight:600; font-size: medium; margin-top: 10px;">Event Payment Received</h3>
                            <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-400)">
                                <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                    <!-- status feild -->
                                    <div style="margin:var(--p-space-200) 0;">
                            ...
                            <hr>
                            <!-- form section 6 -->
                            <h3 style="font-weight:600; font-size: medium; margin-top: 10px;">Event Send Bank Details on Order Placed (Bank Deposit)</h3>
                            <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-400)">
                                <div class="Polaris-FormLayout__Item Polaris-FormLayout--grouped">
                                    <!-- status feild -->
                                    <div style="margin:var(--p-space-200) 0;">
