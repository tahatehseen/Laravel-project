    ...
    <div class="Polaris-Box" style="--pc-box-background:var(--p-color-bg-surface);--pc-box-min-height:100%;vertical-align: middle;">
        <div class="mob-center ">
            <ul style="display: flex; padding:6px; justify-content: center; margin:0;">
                ...
                <li>
                    <a class="a" style="text-decoration: none; color: black;" href="{{Route('orders-verification')}}">
                ...
                <li>
                    <a class="a" style="text-decoration: none; color: black;" href="{{Route('bulkSMS')}}">
                ...
                <li>
                    <div class="dropdown">
                        ...
                        <div class="drop-content" style="z-index: 1000; position: fixed; width: 10%;">
                            <a href="{{Route('abandonedOrder')}}">Abandoned Orders</a>
                            <a href="{{Route('DiscountCode')}}">Discount Codes</a>
                            <a href="{{Route('msgSetting')}}">Message Setting</a>
                        </div>
                    </div>
                </li>
                <li>
                    <a class="a" style="text-decoration: none; color: black;" href="{{Route('orders')}}">
                ...
                <li>
                    <div class="dropdown">
                        ...
                        Settings</button>
                        <div class="drop-content" style="z-index: 1000; position: fixed; width: 10%;">
                            <a href="{{Route('apiConfig')}}">API Configuration</a>
                            <a href="{{Route('appSetting')}}">App Setting</a>
                        </div>
                    </div>
                </li>
            </ul>
